...
echo "The format MUST BE  '%s' . Enter the new value: " $cip ; read cip
...
echo "your fqdn: " $fqdn1 ; read fqdn1
...
ipeth=eth0
echo "Please enter your default ethernet port like '%s' . Enter it : " $ipeth ; read ipeth
